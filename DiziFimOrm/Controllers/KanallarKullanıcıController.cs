...
{
    public class KanallarKullanıcıController : Controller
    {
        private readonly ApplicationDbContext _db;
        public KanallarKullanıcıController(ApplicationDbContext db)
        {
            _db = db;
        }
        public IActionResult Index()
        {
            ...
            var birlestir = from k in kanallar
                            ...
                            into sıralamalar from o in sıralamalar.DefaultIfEmpty()
                            select new joinler
                            {
                                kanallar = k,
                                diziler = d,
